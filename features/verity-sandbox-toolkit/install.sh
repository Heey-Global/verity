...
case "$ARCH" in
  amd64)
    ...
    DOPPLER_SHA256=67e4e020761adf3ffe5a030712d61721b4e2752182670bf90de5a2a88e4961e3
  ...
  arm64)
    ...
    DOPPLER_SHA256=621456ac08436c4037a72c8641e4bdcccd0e404ab43b79a61d449445bb02e6e5
