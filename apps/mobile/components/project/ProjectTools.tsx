// Project tools shared by the Dev Server and Automations routes.
import {
  VerityApiError,
...
function ProjectDetailView({
  ...
  return (
    <View style={styles.flex}>
      <Stack.Screen options={{ title: mode === 'dev-server' ? 'Dev Server' : 'Automations' }} />
